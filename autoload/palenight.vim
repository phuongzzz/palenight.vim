...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#0a0f13", "cterm": "235", "cterm16": "0" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#222534", "cterm": "236", "cterm16": "8" }),
      ...
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#0a0f13", "cterm": "59", "cterm16": "15" }),
      \}
